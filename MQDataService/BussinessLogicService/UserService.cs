...
namespace MQDataService.BussinessLogicService
{
    public class UserService
    {
        ...
        public UserService(IDbContextScopeFactory dbContextScopeFactory, IUserRepository userRepository)
        {
        ...
        public void CreateUser(User userToCreate)
        {
            using (var dbContextScope = _dbContextScopeFactory.Create())
            {
                ...
                var user = new User()
                {
                    guid = userToCreate.guid,
                    Name = userToCreate.Name,
                    Memo = userToCreate.Memo
                };
